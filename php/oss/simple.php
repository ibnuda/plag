...
define('OSS_PATH', 'http://localhost:9090/');
define('OSS_CONNECT_TIMEOUT', 10);
define('OSS_LOGIN', 'ibnu');
define('OSS_APIKEY', '94e1e758761349700f89e6985d42ec58');
define('OSS_INDEX_NAME', 'qwer');
define('OSS_QUERY_NAME', 'search');
define('OSS_MAX_ROW_COUNT', 50);
 
 
 // Get the keywords if any
$query = stripcslashes($_REQUEST['search']);
